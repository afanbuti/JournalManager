...
Date.prototype.MagicInfo = function(type,y,m,d)
 { 
 var result='';
...
case 'SX':
 ...
 result = SXDict.charAt((y-4)%12);
  break;
case 'XZ':
if (month == 1 && date >=20 || month == 2 && date <=18) {result = "\u6c34\u74f6";}
if (month == 2 && date >=19 || month == 3 && date <=20) {result = "\u53cc\u9c7c";}
if (month == 3 && date >=21 || month == 4 && date <=19) {result = "\u767d\u7f8a";}
if (month == 4 && date >=20 || month == 5 && date <=20) {result = "\u91d1\u725b";}
if (month == 5 && date >=21 || month == 6 && date <=21) {result = "\u53cc\u5b50";}
if (month == 6 && date >=22 || month == 7 && date <=22) {result = "\u5de8\u87f9";}
if (month == 7 && date >=23 || month == 8 && date <=22) {result = "\u72ee\u5b50";}
if (month == 8 && date >=23 || month == 9 && date <=22) {result = "\u5ba4\u5973";}
if (month == 9 && date >=23 || month == 10 && date <=22) {result = "\u5929\u79e4";}
if (month == 10 && date >=23 || month == 11 && date <=21) {result = "\u5929\u874e";}
if (month == 11 && date >=22 || month == 12 && date <=21) {result = "\u4eba\u9a6c";}
if (month == 12 && date >=22 || month == 1 && date <=19) {result = "\u6469\u7faf";}
break;
 }
return result;
}
function getTimeinnerHTML(v){
var y=v.substr(0,4);
var m=v.substr(5,2);
var d=v.substr(8,2);
//alert(y+"="+m+"="+d);
document.getElementById('vname').innerHTML="\u3010\u751f\u8096"+Date.prototype.MagicInfo('SX',y,m,d)+"*"+Date.prototype.MagicInfo('XZ',y,m,d)+"\u3011";
document.getElementById('sx').value=Date.prototype.MagicInfo('SX',y,m,d);
document.getElementById('xz').value=Date.prototype.MagicInfo('XZ',y,m,d);
//alert("\u3010\u751f\u8096"+Date.prototype.MagicInfo('SX',y,m,d)+"\u3011&nbsp;\u3010\u661f\u5ea7"+Date.prototype.MagicInfo('XZ',y,m,d)+"\u3011");
//clipboardData.setData("Text","\u3010\u751f\u8096"+Date.prototype.MagicInfo('SX',y,m,d)+"\u3011&nbsp;\u3010\u661f\u5ea7"+Date.prototype.MagicInfo('XZ',y,m,d)+"\u3011");
}