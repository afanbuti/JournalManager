<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userModify.aspx.cs" Inherits="JournalWeb.user.userModify" %>
...
<head runat="server">
    ...
    function checkForm()
    {
        ...
        $.ajax({
            ...
            data:"uid="+uid+"&uname="+escape(user)+"&pwd="+newpass+"&rname="+escape(realName)+"&gid="+gid+"&tp=uMod&bh="+BH,
     ...
     <table cellpadding="0" cellspacing="0" border="0" align="center"> 
                ...
                <tr>
                    <td colspan="3" height="20px">
                        ...
                        <input id="hidgid" type="hidden" runat="server" style="width: 88px" />
                        <input id="hidOrder" style="width: 96px" type="hidden" runat="server" /></td>
                </tr>
                <tr>
